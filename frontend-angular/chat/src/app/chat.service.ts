...
const baseUrl = `${environment.CHAT_FACADE_BASE_URL}/messages`;
const tenantIdUrl = `${environment.CHAT_FACADE_BASE_URL}/userTenantId`;
...
export class UserService {
  ...
  post(message: Chat, token: string) {
    ...
    const authHeader = new HttpHeaders({ Authorization: `Bearer ${tokenData}` });
