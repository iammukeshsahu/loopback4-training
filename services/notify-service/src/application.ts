...
// import {SNSBindings, SESBindings} from 'loopback4-notification/sns';

dotenv.config();

export {ApplicationConfig};

export class NotifyServiceApplication extends BootMixin(
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    // Add authorizatioBearerVerifierComponent component
